...
namespace SCNCore_Plus_Server
{
    public class Application_Paths
    {
        public static string logs_dir = Path.Combine(GetBasePath(), "0x101 Cyber Security", "SCNCore Plus", "Server", "Logs");
        ...
        public static string _private_files_scncore = Path.Combine(GetCurrentDirectory(), "www", "private", "files", "scncore");
        public static string _private_files_scncore_temp = Path.Combine(GetCurrentDirectory(), "www", "private", "files", "scncore", "temp");        
        ...
        //OSSCH_START 00190c6e-1e02-4102-a727-b7b04501494c //OSSCH_END
