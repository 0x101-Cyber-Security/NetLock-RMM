...
namespace SCNCore_Plus_Server.Uptime_Monitoring
{
    public class Handler
    {
        public static async Task Do(string identityJson, bool connected)
        {
            ...
            try
            {
                ...
                string description = connected ? "Connection to SCNCore Plus server restored." : "The device lost connection to the SCNCore Plus server.";
