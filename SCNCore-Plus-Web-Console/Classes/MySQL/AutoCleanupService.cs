...
namespace SCNCore_Plus_Web_Console.Classes.MySQL
{
    public class AutoCleanupService : BackgroundService
    {
        ...
        private async Task Clean()
        {
            try
            {
                ...
                MySqlConnection conn = new MySqlConnection(SCNCore_Plus_Web_Console.Configuration.MySQL.Connection_String);
                ...
                if (cleanup_applications_drivers_history_enabled)
                {
                    ...
                    await SCNCore_Plus_Web_Console.Classes.MySQL.Handler.Execute_Command(query);
                }
