...
{
    private readonly SymmetricSecurityKey _signingKey = new(Encoding.UTF8.GetBytes(SCNCore_Plus_Web_Console.Configuration.Web_Console.token_service_secret_key));
