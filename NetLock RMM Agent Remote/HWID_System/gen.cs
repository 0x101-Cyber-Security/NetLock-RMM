        ...
        static ENGINE()
        {
            ...
            else if (OperatingSystem.IsLinux())
            {
                try
                {
                    ...
                    // Combining the data
                    string rawHwid = $"{Remote_Worker.access_key}"; // we use the access key to generate the hwid because I yet dont know a better way to generate a hwid on linux, without causing problems in the future
