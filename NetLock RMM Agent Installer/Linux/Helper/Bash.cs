...
namespace Helper
{
    internal class Bash
    {
        public static string Execute_Script(string type, bool decode, string script)
        {
            try
            {
                Logging.Handler.Debug("Linux.Helper.Bash.Execute_Script", "Executing script", $"type: {type}, script length: {script.Length}");

                if (String.IsNullOrEmpty(script))
                {
                    Logging.Handler.Error("Linux.Helper.Bash.Execute_Script", "Script is empty", "");
                    return "-";
                }
                ...
                if (decode)
                {
                    ...
                    Logging.Handler.Debug("Linux.Helper.Bash.Execute_Script", "Decoded script", script);
                }
                ...
                using (Process process = new Process())
                {
                    ...
                    {
                        Logging.Handler.Error("Linux.Helper.Bash.Execute_Script", "Error executing script", error);
            ...
            {
                Logging.Handler.Error("Linux.Helper.Bash.Execute_Script", "Error executing script", ex.ToString());
                return ex.Message;
            }
        }
    }
