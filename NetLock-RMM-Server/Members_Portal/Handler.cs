        ...
        public static async Task <bool> Update_License_Information()
        {
            try
            {
                ...
                using (var httpClient = new HttpClient())
                {
                    ...
                    var response = await httpClient.PostAsync(Application_Settings.Members_Portal_Api_Url + "/api/membership/information/history", new StringContent(json, Encoding.UTF8, "application/json"));
