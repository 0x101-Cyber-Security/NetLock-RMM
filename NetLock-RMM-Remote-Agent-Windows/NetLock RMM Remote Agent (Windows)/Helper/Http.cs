...
namespace Helper
{
    internal class Http
    {
        ...
        public static async Task<string> UploadFileAsync(bool ssl, string url, string filePath, string package_guid)
        {
            ...
            try
            {
                Logging.Handler.Debug("Helper.Http.UploadFileAsync", "Trying to upload file", "URL: " + url + " Source: " + filePath);
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    Logging.Handler.Debug("Helper.Http.UploadFileAsync", "Upload successful", "URL: " + url + " Source: " + filePath);
            ...
            {
                Logging.Handler.Error("Helper.Http.UploadFileAsync", "General error", ex.ToString());
                return ex.Message;
            }
        }
