...
namespace SCNCore_Plus_Agent_Installer
{
    internal class Uninstall
    {
        public static void Clean()
        {
            ...
            {
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCore_Plus_Agent_Comm");
                Helper.Service.Stop("SCNCore_Plus_Agent_Comm");
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCore_Plus_Agent_Remote");
                Helper.Service.Stop("SCNCore_Plus_Agent_Remote");
                Logging.Handler.Debug("Main", "Stopping services.", "SCNCore_Plus_Agent_Health");
                Helper.Service.Stop("SCNCore_Plus_Agent_Health");

                // For legacy installations (2.0.0.0)
                Logging.Handler.Debug("Main", "Stopping services (legacy).", "SCNCore_Plus_Comm_Agent_Windows");
                Helper.Service.Stop("SCNCore_Plus_Comm_Agent_Windows");
                Logging.Handler.Debug("Main", "Stopping services (legacy).", "SCNCore_Plus_Health_Agent_Windows");
                Helper.Service.Stop("SCNCore_Plus_Health_Agent_Windows");
                Logging.Handler.Debug("Main", "Stopping services (legacy).", "SCNCore_Plus_Remote_Agent_Windows");
                Helper.Service.Stop("SCNCore_Plus_Remote_Agent_Windows");
            }
            else if (OperatingSystem.IsLinux())
            {
                Logging.Handler.Debug("Main", "Stopping services.", "scncore-plus-agent-comm");
                Bash.Execute_Script("Stopping services", false, "systemctl stop scncore-plus-agent-comm");
                Logging.Handler.Debug("Main", "Stopping services.", "scncore-plus-agent-remote");
                Bash.Execute_Script("Stopping services", false, "systemctl stop scncore-plus-agent-remote");
                Logging.Handler.Debug("Main", "Stopping services.", "scncore-plus-agent-health");
                Bash.Execute_Script("Stopping services", false, "systemctl stop scncore-plus-agent-health");
            }
            ...
            if (OperatingSystem.IsWindows())
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Comm.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCore_Plus_Agent_Comm.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Remote.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCore_Plus_Agent_Remote.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Health.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCore_Plus_Agent_Health.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_User_Process.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCore_Plus_User_Process.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_User_Process_UAC.exe");
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCore_Plus_User_Process_UAC.exe\"");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore Plus User Process.exe"); // kill legacy process
                Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"SCNCore Plus User Process.exe\""); // kill legacy process

                Thread.Sleep(5000); // Wait a little to allow service manager to release handles to prevent service marked for deletion error

                //Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"yara64.exe\""); // yara64.exe is (currently) not used in the project, its part of a scncore legacy feature
                //Helper._Process.Start("cmd.exe", "/c taskkill /F /IM \"devcon_x64.exe\""); // devcon_x64.exe is (currently) not used in the project, its part of a scncore legacy feature
            }
            else if (OperatingSystem.IsLinux())
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "scncore-plus-agent-comm");
                Bash.Execute_Script("Terminating processes", false, "pkill -f scncore-plus-agent-comm");
                Logging.Handler.Debug("Main", "Terminating processes.", "scncore-plus-agent-remote");
                Bash.Execute_Script("Terminating processes", false, "pkill -f scncore-plus-agent-remote");
                Logging.Handler.Debug("Main", "Terminating processes.", "scncore-plus-agent-health");
                Bash.Execute_Script("Terminating processes", false, "pkill -f scncore-plus-agent-health");
                Logging.Handler.Debug("Main", "Terminating processes.", "scncore-plus-user-process");
                Bash.Execute_Script("Terminating processes", false, "pkill -f scncore-plus-user-process");
            }
            else if (OperatingSystem.IsMacOS())
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Comm");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCore_Plus_Agent_Comm");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Remote");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCore_Plus_Agent_Remote");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Health");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCore_Plus_Agent_Health");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_User_Process");
                Zsh.Execute_Script("Terminating processes", false, "pkill SCNCore_Plus_User_Process");
            }
            ...
            if (OperatingSystem.IsWindows())
            {
                Logging.Handler.Debug("Main", "Deleting services.", "SCNCore_Plus_Agent_Comm");
                Helper._Process.Start("cmd.exe", "/c sc delete SCNCore_Plus_Agent_Comm");
                Logging.Handler.Debug("Main", "Deleting services.", "SCNCore_Plus_Agent_Remote");
                Helper._Process.Start("cmd.exe", "/c sc delete SCNCore_Plus_Agent_Remote");
                Logging.Handler.Debug("Main", "Deleting services.", "SCNCore_Plus_Agent_Health");
                Helper._Process.Start("cmd.exe", "/c sc delete SCNCore_Plus_Agent_Health");

                // Unregister user process
                Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Unregistering user process.");
                Logging.Handler.Debug("Main", "Unregistering user process", "SCNCore Plus User Process");
                Windows.Helper.Registry.HKLM_Delete_Value(Application_Paths.hklm_run_directory_reg_path, "SCNCore Plus User Process");
            }
            else if (OperatingSystem.IsLinux())
            {
        ...
        public static void Fix()
        {
            ...
            {
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Comm");
                Zsh.Execute_Script("Terminating processes", false, "pkill -f SCNCore_Plus_Agent_Comm");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Remote");
                Zsh.Execute_Script("Terminating processes", false, "pkill -f SCNCore_Plus_Agent_Remote");
                Logging.Handler.Debug("Main", "Terminating processes.", "SCNCore_Plus_Agent_Health");
                Zsh.Execute_Script("Terminating processes", false, "pkill -f SCNCore_Plus_Agent_Health");
            }
            Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Terminated processes.");
