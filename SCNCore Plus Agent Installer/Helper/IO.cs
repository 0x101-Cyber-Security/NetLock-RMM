    ...
    internal class IO
    {
        ...
        public static void Delete_File(string path)
        {
            try
            {
                ...
                Logging.Handler.Debug("Helper.IO.Delete_File", "Deleted file.", path);
            }
            catch (Exception ex)
            {
                Logging.Handler.Error("Helper.IO.Delete_File", "Delete file failed: " + path, ex.ToString());
        ...
        public static void Delete_Directory(string path)
        {
            try
            {
                ...
                Logging.Handler.Debug("Helper.IO.Delete_Directory", "Deleted directory.", path);
            }
            catch (Exception ex)
            {
                Logging.Handler.Error("Helper.IO.Delete_Directory", "Delete directory failed: " + path, ex.ToString());
