...
namespace Windows.Helper
{
    internal class Registry
    {
        public static bool HKLM_Key_Exists(string path)
        {
            ...
            {
                Logging.Handler.Error("Helper.Registry_Handler.HKLM_Key_Exists", "Path: " + path, "Failed: " + ex.ToString());
                return false;
            }
        }
        ...
        public static void HKLM_Create_Key(string path)
        {
            ...
            {
                Logging.Handler.Error("Helper.Registry_Handler.HKLM_Create_Key", "Path: " + path, "Failed: " + ex.ToString());
            }
        }
        ...
        public static string HKLM_Read_Value(string path, string value)
        {
            ...
            {
                Logging.Handler.Error("Helper.Registry_Handler.HKLM_Read_Value", "Path: " + path + " Value: " + value, "Failed: " + ex.ToString());
                return null;
            }
        }
        ...
        public static bool HKLM_Write_Value(string path, string value, string content)
        {
            ...
            {
                Logging.Handler.Error("Helper.Registry_Handler.HKLM_Write_Value", "Path: " + path + " Value: " + value + " Content: " + content, "Failed: " + ex.ToString());
                return false;
            }
        }
        ...
        public static bool HKLM_Delete_Value(string path, string value)
        {
            ...
            {
                Logging.Handler.Error("Helper.Registry_Handler.HKLM_Delete_Value", "Path: " + path + " Value: " + value, "Failed: " + ex.ToString());
                return false;
            }
