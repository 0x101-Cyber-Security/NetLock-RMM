    ...
    internal class Program
    {
        ...
        static async Task MainAsync(string[] args)
        {
            try
            {
                ...
                Console.Title = "SCNCore Plus Agent Installer";
...
";
                ...
                // Create temp dir
                if (!Directory.Exists(Application_Paths.c_temp_scncore_dir))
                    Directory.CreateDirectory(Application_Paths.c_temp_scncore_dir);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + comm_package_url, Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.comm_agent_package_path), server_config_new.package_guid);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + remote_package_url, Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.remote_agent_package_path), server_config_new.package_guid);
                ...
                http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + health_package_url, Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.health_agent_package_path), server_config_new.package_guid);
                ...
                if (OperatingSystem.IsWindows())
                {
                    http_status = await Helper.Http.DownloadFileAsync(server_config_new.ssl, update_server + user_process_package_url, Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.user_process_package_path), server_config_new.package_guid);
                ...
                string comm_agent_package_path = Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.comm_agent_package_path);
                ...
                string remote_agent_package_path = Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.remote_agent_package_path);
                ...
                string health_agent_package_path = Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.health_agent_package_path);
                ...
                string user_process_package_path = Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.user_process_package_path);
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.comm_agent_package_path), Application_Paths.program_files_comm_agent_dir, true);
                ...
                ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.remote_agent_package_path), Application_Paths.program_files_remote_agent_dir, true);
                ...
                if (arg1 == "clean")
                {
                    ...
                    ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.health_agent_package_path), Application_Paths.program_files_health_agent_dir, true);
                }
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    ZipFile.ExtractToDirectory(Path.Combine(Application_Paths.c_temp_scncore_dir, Application_Paths.user_process_package_path), Application_Paths.program_files_user_agent_dir, true);
                }
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    Process.Start("sc", "create SCNCore_Plus_Agent_Comm binPath= \"" + Application_Paths.program_files_comm_agent_path + "\" start= auto").WaitForExit();
                    ...
                    Process.Start("sc", "create SCNCore_Plus_Agent_Remote binPath= \"" + Application_Paths.program_files_remote_agent_path + "\" start= auto").WaitForExit();
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Process.Start("sc", "create SCNCore_Plus_Agent_Health binPath= \"" + Application_Paths.program_files_health_agent_path + "\" start= auto").WaitForExit();
                ...
                else if (OperatingSystem.IsLinux())
                {
                    ...
                    Bash.Execute_Script("Registering remote agent as service", false,
                        "chmod +x /usr/0x101_Cyber_Security/SCNCore_Plus/Comm_Agent/SCNCore_Plus_Agent_Comm");

                    // Create service file for comm agent
                    Linux.Helper.Linux.CreateServiceFile(Application_Paths.program_files_comm_agent_service_config_path_linux, "scncore-plus-agent-comm", Application_Paths.program_files_comm_agent_service_path_unix, Application_Paths.program_files_comm_agent_dir, Application_Paths.program_files_comm_agent_service_log_path_unix);

                    Bash.Execute_Script("Registering comm agent as service", false,
                        "systemctl enable scncore-plus-agent-comm");
                    ...
                    // Set permissions
                    Bash.Execute_Script("Registering remote agent as service", false,
                        "chmod +x /usr/0x101_Cyber_Security/SCNCore_Plus/Remote_Agent/SCNCore_Plus_Agent_Remote");

                    // Create service file for remote agent
                    Linux.Helper.Linux.CreateServiceFile(Application_Paths.program_files_remote_agent_service_config_path_linux, "scncore-plus-agent-remote", Application_Paths.program_files_remote_agent_service_path_unix, Application_Paths.program_files_remote_agent_dir, Application_Paths.program_files_remote_agent_service_log_path_unix);

                    Bash.Execute_Script("Registering remote agent as service", false,
                        "systemctl enable scncore-plus-agent-remote");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Bash.Execute_Script("Registering health agent as service", false,
                            "chmod +x /usr/0x101_Cyber_Security/SCNCore_Plus/Health_Agent/SCNCore_Plus_Agent_Health");

                        // Create service file for health agent
                        Linux.Helper.Linux.CreateServiceFile(Application_Paths.program_files_health_agent_service_config_path_linux, "scncore-plus-agent_health", Application_Paths.program_files_health_agent_service_path_unix, Application_Paths.program_files_health_agent_dir, Application_Paths.program_files_health_agent_service_log_path_unix);

                        Bash.Execute_Script("Registering health agent as service", false,
                            "systemctl enable scncore-plus-agent-health");
                ...
                if (OperatingSystem.IsWindows())
                {
                    ...
                    Service.Start("SCNCore_Plus_Agent_Comm");
                    ...
                    Service.Start("SCNCore_Plus_Agent_Remote");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Service.Start("SCNCore_Plus_Agent_Health");
                ...
                else if (OperatingSystem.IsLinux())
                {
                    ...
                    Logging.Handler.Debug("Main", "Starting comm agent service", "");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Starting comm agent service.");
                    Bash.Execute_Script("Starting comm agent service", false, "systemctl start scncore-plus-agent-comm");
                    Logging.Handler.Debug("Main", "Start comm agent service", "Done.");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Start comm agent service: Done.");
                    ...
                    Logging.Handler.Debug("Main", "Starting remote agent service", "");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Starting remote agent service.");
                    Bash.Execute_Script("Starting remote agent service", false, "systemctl start scncore-plus-agent-remote");
                    Logging.Handler.Debug("Main", "Start remote agent service", "Done.");
                    Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Start remote agent service: Done.");
                    ...
                    if (arg1 == "clean")
                    {
                        ...
                        Logging.Handler.Debug("Main", "Starting health agent service", "");
                        Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Starting health agent service.");
                        Bash.Execute_Script("Starting health agent service", false, "systemctl start scncore-plus-agent-health");
                        Logging.Handler.Debug("Main", "Start health agent service", "Done.");
                        Console.WriteLine("[" + DateTime.Now + "] - [Main] -> Start health agent service: Done.");
                    }
                }
                ...
                Helper.IO.Delete_Directory(Application_Paths.c_temp_scncore_dir);
